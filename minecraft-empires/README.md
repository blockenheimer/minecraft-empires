...
v1.6.100 – Fundoshi agora é uma nação jogável: bandeira em public/flags/fundoshi.png, território no mapa e botão de seleção (antes de Vulpéria) na criação da sala.
...
- Substituídas pelas imagens reais as bandeiras de Finllandë, USRR, RDPG, Latinus, DSPA, Leasath, Yukiguni, Lythuria, Orenbirsk, Azilus e Afrem.
